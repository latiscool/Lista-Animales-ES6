  ...
  _createClass(Propietario, [
    {
      ...
      value: function datosPropietario() {
        return 'El nombre del due\xF1o es: '
          .concat(this._nombre, '. El domicilio es: ')
          .concat(this._direccion, ' y el numero telefonico de contacto: ')
          .concat(this._telefono);
      },
    },
  ]);
...
formulario.addEventListener('submit', function (event) {
  ...
  var mascotaAgregada = 'El tipo de animal es un: '
    .concat(seleccion.getTipo, ', mientras que el nombre de la mascota es: ')
    .concat(seleccion.nombreMascota, ' y la enfermedad es: ')
    .concat(seleccion.enfermedad); //Mostrado los datos agregado en el formulario

  document.getElementById('resultado').innerHTML = '<li>'
    .concat(seleccion.datosPropietario(), '</li> <li>')
    .concat(mascotaAgregada, '</li>');
});
